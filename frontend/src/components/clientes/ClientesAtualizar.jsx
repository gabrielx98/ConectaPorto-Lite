...
export default class ClientesAtualizar extends Component {
    constructor(props) {
        super(props);
        this.state = {
            cliente: { id: 0, codigo: '', nome: '' },
            loading: true,
            error: null
        }
    }
            ...
            <Main>
                <div className="d-flex justify-content-center">
                    <div className="card mb-3" style={{ width: "500px" }}>
                        <ClientesProvider>
                            {({ clientes, loading, error, atualizarCliente }) => {

                                if (clientes.id !== undefined && this.state.cliente.id === 0) {
                                    this.setState({ cliente: clientes })
                                }
                                ...
                                return (
                                    <form className="d-flex flex-column text-start p-3">
                                        ...
                                        <button onClick={() => this.save(atualizarCliente)} type="button" className="btn btn-primary btn-sm" style={{ width: "60px" }}>Enviar</button>
                                    </form>
                                )
                            }}
                        </ClientesProvider>
